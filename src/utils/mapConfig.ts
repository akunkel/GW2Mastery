...
export const zoneConfigs: Record<string, ZoneConfig> = {
  ...
  'Bloodtide Coast': { regionalExplorerId: KRYTAN_EXPLORER, insightAchievementIds: [3501] },
  ...
  'Frostgorge Sound': { regionalExplorerId: SHIVERPEAK_EXPLORER },
  ...
  // === Heart of Maguuma ===
  'Bloodstone Fen': { offsetY: -20, masteryRegion: 'Maguuma', insightAchievementIds: [3061, 3078] },
  ...
  'Verdant Brink': { explorerAchievementId: 2222 },
  'Auric Basin': { explorerAchievementId: 2370, insightAchievementIds: [2164, 2168, 2517, 2267, 2204, 2612, 2143, 2608] },
  ...
  'Ember Bay': { insightAchievementIds: [3103, 3116] },
  ...
  "Siren's Landing": { insightAchievementIds: [3475, 3508, 3506, 3477, 3490] },
  ...
  'Elon Riverlands': { explorerAchievementId: 3623, insightAchievementIds: [3795, 3563, 3704, 3761, 3603, 3701, 3767, 3852] },
  'The Desolation': { explorerAchievementId: 3612, insightAchievementIds: [3645, 3592, 3885, 3659, 3620, 3695, 3573, 3600] },
  ...
  Dragonfall: { insightAchievementIds: [4701, 4664, 4685, 4741, 4690, 4735] },

  // === Icebrood Saga ===
  'Grothmar Valley': { insightAchievementIds: [5128, 5111] },
  'Bjora Marches': { insightAchievementIds: [5088, 5058, 5129, 5041, 5043, 5090, 5057] },
  'Drizzlewood Coast': { insightAchievementIds: [5374, 5336, 5415, 5333, 5378, 5396, 5421, 5326, 5303] },
  ...
  'New Kaineng City': { explorerAchievementId: 6142, insightAchievementIds: [6341, 6477, 6182, 6365, 6449, 6177, 6441, 6476, 6507, 6379, 6214, 6128, 6389] },
  ...
  Amnytas: { explorerAchievementId: 7054, insightAchievementIds: [6977, 7124, 7045, 6966, 7209, 6999, 7182, 7213, 7046] },
  ...
  // === Janthir Wilds ===
  'Lowland Shore': { explorerAchievementId: 8154, insightAchievementIds: [8235, 8365, 8169, 8307, 8321, 8215, 8212, 8295, 8220, 8176, 8238] },
