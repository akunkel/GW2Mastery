...
const mapConfigs: Record<string, MapConfig> = {
    Arborstone: { offsetY: -2300, scaleX: 0.75, scaleY: 0.75 },
    'Bloodstone Fen': { offsetY: -20 },
    'Dry Top': { adjustBounds: { top: 950 } },
    'Spirit Vale': { offsetY: -250 },
    'The Silverwastes': { adjustBounds: { bottom: -200 } },
};
